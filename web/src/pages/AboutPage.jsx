  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <h1 style={{ color: Colors.white, fontSize: 17, fontWeight: 600, margin: 0 }}>About</h1>
      </header>

      <div style={{ flex: 1, overflowY: 'auto', padding: '32px 24px', textAlign: 'center' }}>
        <div style={{
          width: 80, height: 80, borderRadius: 20, background: Colors.primary,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          margin: '0 auto 16px',
        }}>
          <MessageCircle size={40} color={Colors.white} />
        </div>
        <h2 style={{ fontSize: 22, fontWeight: 700, color: Colors.textPrimary, margin: '0 0 4px' }}>WhatsApp Clone</h2>
        <p style={{ fontSize: 14, color: Colors.textSecondary, margin: '0 0 24px' }}>
          Version 1.0.0
        </p>
        <p style={{ fontSize: 14, color: Colors.textSecondary, lineHeight: 1.6, maxWidth: 320, margin: '0 auto 32px' }}>
          A real-time messaging application built with React, Node.js, and Socket.IO. Features include instant messaging, voice and video calls, group chats, and end-to-end encryption.
        </p>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'center' }}>
          <a href="#" onClick={(e) => e.preventDefault()} style={{ display: 'flex', alignItems: 'center', gap: 8, color: Colors.primary, fontSize: 14, textDecoration: 'none' }}>
